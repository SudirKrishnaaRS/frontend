export default function CheckExampleCard() {
  return (
    <div className="rounded-[2px] border border-[#e5e5e5] bg-white p-4">
      <div className="space-y-2 text-center">
        ...
        <div className="mx-auto max-w-[420px] space-y-[6px]">
          <div className="flex h-12 items-center justify-center bg-[#e2e8f0] px-2">
            <p className="font-mono text-[22px] leading-[1.2] text-[#152644]">
